...
class TestSpecialCharacters(unittest.TestCase):
    ...
    def test_ids_special_characters(self):
        ...
        for special_str in self.special_chars:
            ...
            if "'" in special_str:
                ...
                # pymysql escape_string uses backslash escaping
                expected_escaped = escape_string(special_str)
                self.assertIn(expected_escaped, sql)
    ...
    def test_documents_special_characters(self):
        ...
        for special_str in self.special_chars:
            ...
            expected_escaped = escape_string(special_str)
            self.assertIn(expected_escaped, executed_sql)
